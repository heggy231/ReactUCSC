...
var redux_logger_1 = __webpack_require__(68);
var index_reducer_1 = __webpack_require__(69);
var app_container_1 = __webpack_require__(71);
var middleware = redux_1.applyMiddleware(redux_logger_1.default);
var store = redux_1.createStore(index_reducer_1.default, middleware);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(11), __webpack_require__(50)(module)))
...
Object.defineProperty(exports, "__esModule", { value: true });
var redux_1 = __webpack_require__(9);
var EntryReducer = __webpack_require__(74);
var ListReducer = __webpack_require__(76);
var indexReducer = redux_1.combineReducers({
...
Object.defineProperty(exports, "__esModule", { value: true });
var name_actions_1 = __webpack_require__(75);
var app_1 = __webpack_require__(73);
var mapStateToProps = function (state) { return state; };
var mapDispatchToProps = function (dispatch) {
    return {
        appChangeName: function (name) { return dispatch(name_actions_1.change(name)); }
    };
};
var AppContainer = connect(mapStateToProps, mapDispatchToProps)(app_1.default);
...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("input", { className: "form-control", type: "text", value: this.props.nameEntry, onChange: function (evt) {
                    _this.props.appChangeName(evt.target.value);
                } }),
            React.createElement("input", { className: "form-control", type: "button", value: "Add Name", onClick: function (evt) {
                    _this.props.appUpdateList(_this.props.nameEntry);
                } })));
    };
    return App;
}(React.Component));
